...
final class TeamsPartialUpdate extends BaseEndpoint implements Psr7Endpoint
{
     ...
     */
    public function __construct(string $subdomain, Team $requestBody)
    {
