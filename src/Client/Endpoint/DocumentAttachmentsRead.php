...
final class DocumentAttachmentsRead extends \Jane\OpenApiRuntime\Client\BaseEndpoint implements \Jane\OpenApiRuntime\Client\Psr7Endpoint
{
    ...
    {
        return str_replace(['{uuid}'], [$this->uuid], '/document-attachments/{uuid}/');
    }
