...
final class EventsGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'SignRequest\\Client\\Model\\EventsGetResponse200';
    }

    public function supportsNormalization($data, string $format = null)
    {
        return is_object($data) && get_class($data) === 'SignRequest\\Client\\Model\\EventsGetResponse200';
    }
    ...
    public function denormalize($data, $class, string $format = null, array $context = [])
    {
        ...
        $object = new \SignRequest\Client\Model\EventsGetResponse200();
        ...
        if (property_exists($data, 'results') && $data->{'results'} !== null) {
            ...
            foreach ($data->{'results'} as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'SignRequest\\Client\\Model\\Event', 'json', $context);
            }
